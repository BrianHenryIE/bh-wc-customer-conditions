 ...
 * @@coversDefaultClass \BrianHenryIE\WC_Customer_Conditions\WooCommerce_Conditional_Shipping_And_Payments\WC_CSP_Conditions
 */
class WC_CSP_Conditions_Test extends \Codeception\Test\Unit {
	...
	public function test_add_is_paying_customer_condition() {
		...
		$this->assertContains( 'BrianHenryIE\WC_Customer_Conditions\WooCommerce_Conditional_Shipping_And_Payments\WC_CSP_Condition_Customer_Is_Paying_Customer', $result );
	...
	public function test_add_order_count_condition() {
		...
		$this->assertContains( 'BrianHenryIE\WC_Customer_Conditions\WooCommerce_Conditional_Shipping_And_Payments\WC_CSP_Condition_Customer_Order_Count', $result );
	...
	public function test_add_total_spend_condition() {
		...
		$this->assertContains( 'BrianHenryIE\WC_Customer_Conditions\WooCommerce_Conditional_Shipping_And_Payments\WC_CSP_Condition_Customer_Total_Spend', $result );
